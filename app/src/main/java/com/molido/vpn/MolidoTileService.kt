...
class MolidoTileService : TileService() {
    ...
    private fun updateTile() {
        ...
        tile.label = Strings.t("MolidoVPN")
    ...
    private fun toggleConnection(): Boolean {
        ...
        if (permissionIntent == null) {
            ...
            startForegroundService(
                Intent(this, MolidoVpnService::class.java)
    ...
    companion object {
        private const val LOG_TAG = "MolidoTile"
        ...
        enum class Protocol(
            ...
            // "auto" is resolved by MolidoVpnService's Auto selection (tests every
